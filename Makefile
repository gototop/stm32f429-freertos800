...
UGFX_MANDEL_OBJS = \
    gdisp_lld_ILI9341.o \
    ginput_lld_mouse.o \
    main-ugfx-mandelbrot.o \
    ParTest.o \
    port.o \
    timertest.o \
    system_stm32f4xx.o
UGFX_BENCHMARKS_OBJS = \
    gdisp_lld_ILI9341.o \
    ginput_lld_mouse.o \
    main-ugfx-benchmarks.o \
    ParTest.o \
    port.o \
    timertest.o \
    system_stm32f4xx.o
...
UGFX_MANDEL_OBJS += startup_stm32f429_439xx.o
UGFX_BENCHMARKS_OBJS += startup_stm32f429_439xx.o
SHELL_OBJS += startup_stm32f429_439xx.o
...
ugfx-mandelbrot: $(UGFX_MANDEL_OBJS)
ugfx-mandelbrot: CFLAGS += -DGFX_USE_OS_FREERTOS=TRUE -DGFX_MANDELBROT_DEMO=TRUE
ugfx-mandelbrot: OBJS = $(UGFX_MANDEL_OBJS)
ugfx-mandelbrot: $(BIN_IMAGE)

ugfx-benchmarks: $(UGFX_BENCHMARKS_OBJS)
...
shell: $(SHELL_OBJS)
shell: CFLAGS += -DGFX_USE_OS_FREERTOS=TRUE -DGFX_MANDELBROT_DEMO=TRUE -DGFX_NOTEPAD_DEMO=TRUE
